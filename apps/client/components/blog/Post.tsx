...
// // Function to return string of item.categories separated by comma from a list of categories or return "Test" if no categories
...
//   description = description.replace(/<figure[^>]*>.*?<\/figure>/g, "");
//   return description.substring(0, description.indexOf("</p>", description.indexOf("</p>", description.indexOf("</p>") + 1) + 1));
// }

// // Separate component for rendering blog post image
// const BlogImage = ({ thumbnail }) => {
//   const sanitizedThumbnail = DOMPurify.sanitize(thumbnail);
//   return <img src={sanitizedThumbnail ? sanitizedThumbnail : ""} alt="image" />;
// };

// export default function Post(props) {
//   const { data, i } = props;
//   const { link, thumbnail, pubDate, title, description, categories } = data; // Destructuring assignment
...
//             <div className="post-tag">
//               <Link href={link}>
//                 <a href={DOMPurify.sanitize(link)}>{getCategories(categories)}</a>
//               </Link>
//             </div>
//           </div>
//           <div className="blog-post-content">
...
//               </Link>
//             </h3>
//             <div dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(shortenDescription(description)) }}></div>
//             <Link href={link}>
//               <a className="read-more-btn">
//                 Read More <i className="icofont-double-right"></i>
//               </a>
